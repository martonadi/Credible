<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRD.aspx.cs" ValidateRequest="false" Inherits="CredentialsDemo.PRATICEGROUPS.CRD" %>
...
<head id="Head1" runat="server">
    ...
    <telerik:RadCodeBlock ID="id1" runat="server">
        <script type="text/javascript" language="javascript">
            ...
            (ReturnString('cbo_CRD_ClientTypeIdCommercial') == "Select")) {
        ...
        <table cellpadding="2" cellspacing="0" border="0" width="100%">
            <tr>
                <td colspan="2" align="center">
                    <asp:Label ID="lblname" Text="CRD" runat="server" CssClass="labelStyleHeading"></asp:Label>
                    <br />
                    <br />
                </td>
            </tr>
            <tr style="background-color: White;">
                <td style="width: 21%; padding-left: 10px; padding-top: 10px;" align="left" valign="top">
                    <asp:Label ID="lbl_CRD_Work_Type" Text="Work type" runat="server" CssClass="labelStyle">
                    </asp:Label>
                </td>
                <td style="width: 75%; padding-top: 10px;">
                    <div style="border: 1px solid #000080; overflow: scroll; width: 343px;
            ...
            <tr style="background-color: White;">
                <td align="left" style="padding-left: 10px;">
                    <asp:Label ID="lbl_CRD_ClientTypeIdCommercial" Text="Client type" runat="server"
                        CssClass="labelStyle">
                    </asp:Label>
                </td>
                <td>
                    <telerik:RadComboBox ID="cbo_CRD_ClientTypeIdCommercial" AllowCustomText="false"
                        MarkFirstMatch="true" runat="server" Width="350px" CheckBoxes="false" EnableCheckAllItemsCheckBox="false"
