...
namespace CMS
{
    public partial class Importcred : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                workbook = appExl.Workbooks.Open(Server.MapPath("ReadytoMigrateBankingandFinance (75472068_1).XLS"), Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value);
                    ...
                    try
                    {
                        ...
                        for (int j = 0; j < dt.Columns.Count; j++)
                        {
                            ...
                            if (dt.Columns[j].ColumnName == "4" || dt.Columns[j].ColumnName == "5" || dt.Columns[j].ColumnName == "6")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblClientIndustrySector", "ClientIndustrySectorId", "Client_Industry_Sector", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                                ...
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    if (slSectorGroupMSText.Contains(dt.Rows[l][j].ToString()) == false)
                                    {
                                        slSectorGroupMS.Add(dt.Rows[l][j].ToString(), dt.Rows[l][j].ToString());

                                        if (string.IsNullOrEmpty(strSectorGroupMSText))
                                        {
                                            strSectorGroupMSText = dt.Rows[l][j].ToString().Replace("'", "8@9!");
                                        }
                                        else
                                        {
                                            strSectorGroupMSText = strSectorGroupMSText + "," + dt.Rows[l][j].ToString();
                                        }
                            ...
                            if (dt.Columns[j].ColumnName == "7" || dt.Columns[j].ColumnName == "8" || dt.Columns[j].ColumnName == "9")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblClientIndustryType", "ClientIndustryTypeId", "Client_Industry_Type", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "10" || dt.Columns[j].ColumnName == "11" || dt.Columns[j].ColumnName == "12")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblCountry", "CountryId", "Country", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "13" || dt.Columns[j].ColumnName == "14" || dt.Columns[j].ColumnName == "15")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblBusinessGroup", "BusinessGroupId", "Business_Group", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                                        if (slCountryOfClientMS.Contains(strID) == false)
                                        {
                            ...
                            if (dt.Columns[j].ColumnName == "19" || dt.Columns[j].ColumnName == "20" || dt.Columns[j].ColumnName == "21")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblTransactionIndustrySector", "TransactionIndustrySectorId", "Transaction_Industry_Sector", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                                ...
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    if (slMatterSectorGroupMSText.Contains(dt.Rows[l][j].ToString()) == false)
                                    {
                                        slMatterSectorGroupMSText.Add(dt.Rows[l][j].ToString(), dt.Rows[l][j].ToString());

                                        if (string.IsNullOrEmpty(strMatterSectorGroupMSText))
                                        {
                                            strMatterSectorGroupMSText = dt.Rows[l][j].ToString().Replace("'", "8@9!");
                                        }
                                        else
                                        {
                                            strMatterSectorGroupMSText = strMatterSectorGroupMSText + "," + dt.Rows[l][j].ToString();
                                        }
                            ...
                            if (dt.Columns[j].ColumnName == "22" || dt.Columns[j].ColumnName == "23" || dt.Columns[j].ColumnName == "24")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblTransactionIndustryType", "TransactionIndustryTypeId", "Transaction_Industry_Type", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                                        if (slMatterSubSectorGroupMS.Contains(strID) == false)
                                        {
                                            ...
                                            {
                                                strMatterSubSectorGroupMS = strMatterSectorGroupMS + "," + strID;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (dt.Columns[j].ColumnName == "31")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    ...
                                    {//CountryLawId
                                        strCountryLawSS = GetMultiSelectValueId("tblCountryLaw", "CountryLawId", "Country_law", dt.Rows[l][j].ToString());
                                    }
                                }
                            }
                            ...
                            if (dt.Columns[j].ColumnName == "40")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    ...
                                    {//DisputeResolutionId
                                        strDisputeResolutionSS = GetMultiSelectValueId("tblDisputeResolution", "DisputeResolutionId", "Dispute_Resolution", dt.Rows[l][j].ToString());
                                    }
                            ...
                            if (dt.Columns[j].ColumnName == "41" || dt.Columns[j].ColumnName == "42" || dt.Columns[j].ColumnName == "43")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblLanguageOfDispute", "LanguageOfDisputeId", "Language_Of_Dispute", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "50")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    ...
                                    {//SeatOfArbitrationId 
                                        strSeatOfArbitrationSS = GetMultiSelectValueId("tblSeatOfArbitration", "SeatOfArbitrationId", "Seat_Of_Arbitration", dt.Rows[l][j].ToString());
                                    }
                            ...
                            if (dt.Columns[j].ColumnName == "52")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    ...
                                    {
                                        strArbitralRulesSS = GetMultiSelectValueId("tblArbitralRules", "ArbitralRulesId", "Arbitral_Rules", dt.Rows[l][j].ToString());
                                    }
                            ...
                            if (dt.Columns[j].ColumnName == "54")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    ...
                                    {//InvestigationTypeId
                                        strInvestigationTypeSS = GetMultiSelectValueId("tblInvestigationType", "InvestigationTypeId", "Investigation_Type", dt.Rows[l][j].ToString());
                                    }
                                }
                            }
                            ...
                            if (dt.Columns[j].ColumnName == "56")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    if (string.IsNullOrEmpty(strInvestigationTypeSS))
                                    {//CurrencyOfDealId
                                        strInvestigationTypeSS = GetMultiSelectValueId("tblCurrencyOfDeal", "CurrencyOfDealId", "Currency_Of_Deal", dt.Rows[l][j].ToString());
                                    }
                            ...
                            if (dt.Columns[j].ColumnName == "59" || dt.Columns[j].ColumnName == "60" || dt.Columns[j].ColumnName == "61")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblTeam", "TeamId", "Team", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "66" || dt.Columns[j].ColumnName == "67" || dt.Columns[j].ColumnName == "68")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblSourceOfCredential", "SourceOfCredentialId", "Source_Of_Credential", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "73" || dt.Columns[j].ColumnName == "74" || dt.Columns[j].ColumnName == "75")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblReferredFromOtherCMSOffice", "ReferredFromOtherCMSOfficeId", "Referred_From_Other_CMS_Office", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "76")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    ...
                                    {//CurrencyOfDealId
                                        strLeadCMSFirmSS = GetMultiSelectValueId("tblReferredFromOtherCMSOffice", "ReferredFromOtherCMSOfficeId", "Referred_From_Other_CMS_Office", dt.Rows[l][j].ToString());
                                    }
                            ...
                            if (dt.Columns[j].ColumnName == "80")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    ...
                                    {//CurrencyOfDealId
                                        strCredentialStatusSS = GetMultiSelectValueId("tblCredentialStatus", "CredentialStatusId", "Credential_Status", dt.Rows[l][j].ToString());
                                    }
                            ...
                            if (dt.Columns[j].ColumnName == "81")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    ...
                                    {//CurrencyOfDealId
                                        strCredentialVersionSS = GetMultiSelectValueId("tblCredentialVersion", "CredentialVersionId", "Credential_Version", dt.Rows[l][j].ToString());
                                    }
                            ...
                            if (dt.Columns[j].ColumnName == "83")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    ...
                                    {//CurrencyOfDealId
                                        strCredentialTypeSS = GetMultiSelectValueId("tblCredentialType", "CredentialTypeId", "Credential_Type", dt.Rows[l][j].ToString());
                                    }
                            ...
                            if (dt.Columns[j].ColumnName == "84" || dt.Columns[j].ColumnName == "85" || dt.Columns[j].ColumnName == "86")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblOtherUses", "OtherUsesId", "Other_Uses", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "87")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    ...
                                    {
                                        strPrioritySS = GetMultiSelectValueId("tblPriority", "PriorityId", "Priority", dt.Rows[l][j].ToString());
                                    }
                            ...
                            if (dt.Columns[j].ColumnName == "89" || dt.Columns[j].ColumnName == "90" || dt.Columns[j].ColumnName == "91")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblKnowHow", "KnowHowId", "Know_How", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "93")
                            {
                                ...
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strcbo_BAI_ClientTypeIdBAIF = GetMultiSelectValueId("tblClientType", "ClientTypeId", "Client_Type", dt.Rows[l][j].ToString());
                                }
                            ...
                            if (dt.Columns[j].ColumnName == "95" || dt.Columns[j].ColumnName == "96" || dt.Columns[j].ColumnName == "97")
                            {
                                ...
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblWorkType", "WorkTypeId", "Work_Type", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "98")
                            {
                                ...
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strcbo_CRD_ClientTypeIdCommercial = GetMultiSelectValueId("tblClientType", "ClientTypeId", "Client_Type", dt.Rows[l][j].ToString());
                                }
                            ...
                            if (dt.Columns[j].ColumnName == "102" || dt.Columns[j].ColumnName == "103" || dt.Columns[j].ColumnName == "104")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblSubWorkType", "SubWorkTypeId", "SubWork_Type", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "145")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strcbo_EPC_ClientScopeId = GetMultiSelectValueId("tblClientScope", "ClientScopeId", "Client_Scope", dt.Rows[l][j].ToString());
                                }
                            ...
                            if (dt.Columns[j].ColumnName == "137" || dt.Columns[j].ColumnName == "138" || dt.Columns[j].ColumnName == "139")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblTypeContract", "TypeContractId", "Type_Of_Contract", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "141")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strcbo_EPC_SubjectMatterId = GetMultiSelectValueId("tblSubjectMatter", "SubjectMatterId", "Subject_Matter", dt.Rows[l][j].ToString());
                                }
                            }
                            ...
                            if (dt.Columns[j].ColumnName == "143")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strcbo_EPC_ClientTypeIdEPC = GetMultiSelectValueId("tblClientType", "ClientTypeId", "Client_Type", dt.Rows[l][j].ToString());
                                }
                            }
                            ...
                            if (dt.Columns[j].ColumnName == "111" || dt.Columns[j].ColumnName == "112" || dt.Columns[j].ColumnName == "113")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblActingFor", "ActingForId", "Acting_For", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "126")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strcbo_Cor_ValueRangeEuro = GetMultiSelectValueId("tblValueRange", "ValueRangeId", "Value_Range", dt.Rows[l][j].ToString());
                                }
                            }
                            ...
                            if (dt.Columns[j].ColumnName == "129")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strcbo_Cor_QuarterDealAnnouncedId = GetMultiSelectValueId("tblQuarterDealCompleted", "QuarterDealCompletedId", "Quarter_Deal_Completed", dt.Rows[l][j].ToString());
                                }
                            }
                            ...
                            if (dt.Columns[j].ColumnName == "130")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strcbo_Cor_QuarterDealCompletedId = GetMultiSelectValueId("tblQuarterDealCompleted", "QuarterDealCompletedId", "Quarter_Deal_Completed", dt.Rows[l][j].ToString());
                                }
                            }
                            if (dt.Columns[j].ColumnName == "131")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strtxt_Cor_YearDeal_Announced = GetMultiSelectValueId("tblYearDealCompleted", "YearDealCompletedId", "Year_Deal_Completed", dt.Rows[l][j].ToString());
                                }
                            ...
                            if (dt.Columns[j].ColumnName == "132")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strcbo_Cor_YearDealCompletedId = GetMultiSelectValueId("tblYearDealCompleted", "YearDealCompletedId", "Year_Deal_Completed", dt.Rows[l][j].ToString());
                                }
                            }
                            ...
                            if (dt.Columns[j].ColumnName == "149")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strcbo_ENE_ContractTypeId = GetMultiSelectValueId("tblContractType", "ContractTypeId", "Contract_Type", dt.Rows[l][j].ToString());
                                }
                            }
                            ...
                            if (dt.Columns[j].ColumnName == "150")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strcbo_IPF_ClientTypeIdIPF = GetMultiSelectValueId("tblClientType", "ClientTypeId", "Client_Type", dt.Rows[l][j].ToString());
                                }
                            }
                            ...
                            if (dt.Columns[j].ColumnName == "157")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strpensionSchemeHC = GetMultiSelectValueId("tblPensionScheme", "PensionSchemeId", "PensionScheme", dt.Rows[l][j].ToString());
                                }
                            }
                            ...
                            if (dt.Columns[j].ColumnName == "158" || dt.Columns[j].ColumnName == "159" || dt.Columns[j].ColumnName == "160")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    string strID = GetMultiSelectValueId("tblClientType", "ClientTypeId", "Client_Type", dt.Rows[l][j].ToString());
                                    if (!strID.Equals("0"))
                                    {
                            ...
                            if (dt.Columns[j].ColumnName == "167")
                            {
                                if (!string.IsNullOrEmpty(dt.Rows[l][j].ToString()))
                                {
                                    strcbo_Crt_WorkType_CorpTax = GetMultiSelectValueId("tblWorkType", "WorkTypeId", "Work_Type", dt.Rows[l][j].ToString());
                                }
                            }
                        }
                        ...
                        if (!string.IsNullOrEmpty(strClient) && !string.IsNullOrEmpty(strNameConfidentialSS) && !string.IsNullOrEmpty(strProjDesc))
                        {
                            ...
                            if (blnCheck == true)
                            {
                                ...
                                if (!string.IsNullOrEmpty(strCredentialStatusSS))
                                {
                                    ...
                                    strtblCredValues.Append(strCredentialStatusSS);
                                    strtblCredValues.Append("','");
                                }
                                ...
                                if (!string.IsNullOrEmpty(strProjDesc.Trim()))
                                {
                                    strOptionaltblCredFields.Append("Significant_Features");
                                    strOptionaltblCredFields.Append(",");

                                    strOptionaltblCredValues.Append(strProjDesc.Trim());
                                    strOptionaltblCredValues.Append("','");

                                    if (strClient.Contains("8@9!"))
                                    {
                                        obj.LogWriter(hidCredId.Value + " - Significant_Features =" + strProjDesc);
                                    }
                                }
                                else
                                {
